...
const testTypeOptions = [
  ...
  { value: "Blood Film for Malaria Parasites", label: "Blood Film for Malaria Parasites" },
  { value: "Sickle Cell", label: "Sickle Cell" },
  { value: "HB Electrophoresis (Genotype)", label: "HB Electrophoresis (Genotype)" },
  ...
  { value: "PCR for Tuberculosis (Gene Xpert", label: "PCR for Tuberculosis (Gene Xpert" },
...
const AppointmentForm = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto my-8 bg-white rounded-xl shadow-lg p-6 md:p-10 border border-gray-100">
